    ...
    const StartDatejsx = forwardRef(({ value, onClick }, ref) => (
        <div onClick={onClick} className='flex flex-col sm:border-r-2 sm:px-6 w-full mb-4 sm:mb-0'>
            ...
            <div className='flex relative items-center'>
                <input onChange={e => setStartDateInput(e.target.value)} value={value} ref={ref} className='h-12 bg-transparent border outline-none border-white text-gray-900 text-lg rounded-lg  focus:border-hobbizer block w-full p-2.5 pr-8 z-10' placeholder='From' id='participants' />
