...
const ActivityHolder = (props) => {
    return (
        <a className='sm:w-56 h-28 bg-[#eaeceb] hover:bg-hobbizer duration-200 rounded-md flex cursor-pointer items-center group'>
            <div className='flex items-center gap-1 ml-5'>
                ...
                <p className='group-hover:text-white duration-200'>{props.dayPart}</p>
            </div>
        </a>
    )
}
