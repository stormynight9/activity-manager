    ...
    return (
        <div className='flex justify-between mb-8'>
            <div className='flex flex-col p-3'>
                ...
                <p className='mt-2 text-gray-600'>Sélectionnez votre activité pour votre <span className='lowercase'>{selectedCtx.selectedDay.split(' ')[0]} {selectedCtx.selectedTime}</span></p>
            </div>
        </div>
    )
}
