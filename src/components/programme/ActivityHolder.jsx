...
const ActivityHolder = (props) => {
    ...
    return (
        <Link to='/categories' onClick={setSelectedDateTime} className='w-full sm:w-52  h-28 bg-[#eaeceb] hover:bg-hobbizer duration-200 rounded-md flex cursor-pointer items-center group'>
